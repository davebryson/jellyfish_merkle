...
// ** This code is derived/adapted from Libra.  Primarily for use within JellyFishMerkle **
...
//!
//! ```
//! use jellyfish_merkle::hasher::{CryptoHasher, TestOnlyHasher};
//!
...
const RAPIDO_HASH_SUFFIX: &[u8] = b"@@$$RAPIDO$$@@";
...
impl DefaultHasher {
    fn new_with_salt(typename: &[u8]) -> Self {
        ...
        if !typename.is_empty() {
            ...
            salt.extend_from_slice(RAPIDO_HASH_SUFFIX);
...
/// # Example
/// ```
/// use jellyfish_merkle::hasher::TestOnlyHash;
///
